    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[var(--color-bg)] to-[var(--color-surface)] p-4">
      <div className="card w-full max-w-md p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-[var(--color-muted)] uppercase tracking-wider mb-1.5 ml-1">Username</label>
            <input
              type="text"
              placeholder="johndoe"
              value={username}
          ...
          <div>
            ...
            <input
              ...
              required
            />
            <p className="text-[10px] text-[var(--color-muted)] mt-1.5 ml-1">At least 8 characters required.</p>
          </div>
